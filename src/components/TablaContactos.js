...
const rows = [
  ...
  { id: 'domicilio', numeric: false, disablePadding: true, label: 'Domicilio' },
      ...
      <div className={classes.title}>
        {numSelected > 0 ? (
          <Typography color="inherit" variant="subtitle1">
            {numSelected} Contacto seleccionado
          </Typography>
        ) : (
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{n.domicilio}</TableCell>
                      <TableCell align="center">{n.mail}</TableCell>
